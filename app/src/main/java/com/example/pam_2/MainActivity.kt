...
fun ProdutoItem() {
    ...
    var nome by remember { mutableStateOf("Nome completo") }
    var telefone by remember { mutableStateOf("(##) ######-####") }
    var curso by remember { mutableStateOf("Curso atual") }
    var serie by remember { mutableStateOf("Série atual") }
        ...
        Column (Modifier.padding(16.dp))
        {
            ...
            Row (
                ...
                TextField(
                    ...
                    // Label dentro do textfield, acima do campo
            ...
            Row (
                ...
                Button(
                    onClick = { /*TODO*/ },
                    colors = ButtonDefaults.buttonColors(containerColor = Color(0xFFC9AEED))
                ) {
                    Text(text = "Cadastrar")
                }
            }
